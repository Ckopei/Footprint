            ...
            <div className="container text-center aboutApp">
              <Row>
                <Col size="md-12" className="text-center">
                  ...
                  <br></br>
                  <p className="lead">
                    <span className="strong">Footprint</span> is an app designed
                    to make staying environmentally conscious a bit more fun.
                    You can create an account, check out our tips and tricks,
                    and start tracking what you're doing to help the world you
                    live in. <br></br>
